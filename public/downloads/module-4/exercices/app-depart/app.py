...
Version DE DÉPART — contient un bug volontaire à corriger (exercice de debugging
assisté). Voir exercice-guide-depart.md pour la consigne et exercice-guide-solution.md
pour l'explication complète une fois que vous avez tenté de le résoudre vous-même.
"""
...
# ---------------------------------------------------------------------------
# NOTE (contexte du bug) : ce calcul a été écrit avant le nettoyage du Module 3, qui a
# renommé la colonne "montant_total" en "montant_total_fcfa" pour préciser l'unité.
# Cette ligne n'a pas été mise à jour — c'est le bug volontaire de cet exercice.
